...
const exposureOptions = Platform.OS === 'android' ? exposureOptionsAndroid : exposureOptionsIOS;
...
const ExposureControls = (
  { setExposure, setShowExposureControls, exposure }: ExposureControlsProps,
) => {
  const { width, height } = useWindowDimensions();
  const radius = Math.min(width, height - 100) * 0.35; // Adjust this value to change the size of the circle
